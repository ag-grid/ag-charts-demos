# AG Charts demo: Financial (Angular)

A standalone Angular CLI project running the AG Charts "Financial" demo app with
...
[`packages/ag-charts-demos/src/demos/financial`](https://github.com/ag-grid/ag-charts/tree/latest/packages/ag-charts-demos/src/demos/financial). The demo lives in
