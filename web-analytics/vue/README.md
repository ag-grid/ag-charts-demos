...
[`packages/ag-charts-demos/src/demos/web-analytics`](https://github.com/ag-grid/ag-charts/tree/latest/packages/ag-charts-demos/src/demos/web-analytics), which is the
